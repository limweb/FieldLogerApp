...
[ExcludeClass]
internal class _Allinfo_assetAdvancedEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("asset_active", "asset_toolID", "toolNo", "asset_located", "tool_5", "tool_note", "tool_4", "asset_serialNo", "tool_3", "toolID", "tool_2", "tool_1", "assetNo", "tool_active", "tool_type", "asset_1", "asset_2", "tool_name", "tool_sensor", "asset_5", "asset_status", "asset_3", "asset_ref", "assetID", "asset_4", "asset_note");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("asset_active", "asset_toolID", "toolNo", "asset_located", "tool_5", "tool_note", "tool_4", "asset_serialNo", "tool_3", "toolID", "tool_2", "tool_1", "assetNo", "tool_active", "tool_type", "asset_1", "asset_2", "tool_name", "tool_sensor", "asset_5", "asset_status", "asset_3", "asset_ref", "assetID", "asset_4", "asset_note");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("asset_active", "asset_toolID", "toolNo", "asset_located", "tool_5", "tool_note", "tool_4", "asset_serialNo", "tool_3", "toolID", "tool_2", "tool_1", "assetNo", "tool_active", "tool_type", "asset_1", "asset_2", "tool_name", "tool_sensor", "asset_5", "asset_status", "asset_3", "asset_ref", "assetID", "asset_4", "asset_note");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("asset_active", "asset_toolID", "toolNo", "asset_located", "tool_5", "tool_note", "tool_4", "asset_serialNo", "tool_3", "toolID", "tool_2", "tool_1", "assetNo", "tool_active", "tool_type", "asset_1", "asset_2", "tool_name", "tool_sensor", "asset_5", "asset_status", "asset_3", "asset_ref", "assetID", "asset_4", "asset_note");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("asset_active", "asset_toolID", "toolNo", "asset_located", "tool_5", "tool_note", "tool_4", "asset_serialNo", "tool_3", "toolID", "tool_2", "tool_1", "assetNo", "tool_active", "tool_type", "asset_1", "asset_2", "tool_name", "tool_sensor", "asset_5", "asset_status", "asset_3", "asset_ref", "assetID", "asset_4", "asset_note");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Allinfo_assetAdvanced";
    ...
    model_internal var _instance:_Super_Allinfo_assetAdvanced;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Allinfo_assetAdvancedEntityMetadata(value : _Super_Allinfo_assetAdvanced)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Allinfo_assetAdvanced");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Allinfo_assetAdvanced");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of Allinfo_assetAdvanced");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity Allinfo_assetAdvanced");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity Allinfo_assetAdvanced");
        }
