...
public class _Super_CustomDatatype1 extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
     ...
     * properties
     */
    private var _internal_sensors : Object;
    ...
    public function _Super_CustomDatatype1()
    {
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "sensors", model_internal::setterListenerSensors));
    ...
    public function get sensors() : Object
    {
    ...
    public function set sensors(value:Object) : void
    {
        var oldValue:Object = _internal_sensors;
        if (oldValue !== value)
        {
    ...
    model_internal function setterListenerSensors(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSensors();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.sensorsIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_sensorsValidationFailureMessages);
        }
    ...
    model_internal var _doValidationCacheOfSensors : Array = null;
    model_internal var _doValidationLastValOfSensors : Object;

    model_internal function _doValidationForSensors(valueIn:Object):Array
    {
        var value : Object = valueIn as Object;

        if (model_internal::_doValidationCacheOfSensors != null && model_internal::_doValidationLastValOfSensors == value)
           return model_internal::_doValidationCacheOfSensors ;

        _model.model_internal::_sensorsIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSensorsAvailable && _internal_sensors == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "sensors is required"));
        }

        model_internal::_doValidationCacheOfSensors = validationFailures;
        model_internal::_doValidationLastValOfSensors = value;
