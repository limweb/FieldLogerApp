...
[ExcludeClass]
internal class _Allinfo_service_assetAdvancedEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("asset_active", "sensor_offset_b", "toolNo", "sensor_note", "sensor_gain_a", "toolstring_serialNo", "sensorID", "tool_5", "tool_4", "toolstring_assetID", "tool_3", "tool_2", "tool_1", "ts_sensorID", "assetNo", "tool_active", "ts_5", "ts_4", "ts_3", "ts_2", "ts_1", "toolstring_note", "tool_name", "tool_sensor", "asset_status", "sensor_min", "asset_note", "asset_toolID", "ts_sensorColor", "sensor_5", "toolstring_2", "toolstring_3", "toolstring_4", "toolstring_5", "sensorNo", "toolstring_1", "asset_located", "sensor_max", "sensor_type", "tsNo", "sensor_3", "sensor_4", "tool_note", "sensor_1", "sensor_2", "asset_serialNo", "toolID", "toolstring_serviceID", "tool_type", "ts_assetID", "asset_1", "asset_2", "asset_5", "sensor_name", "asset_3", "asset_ref", "assetID", "asset_4", "toolstringNo", "sensor_unit");
    ...
    model_internal static var entityName:String = "Allinfo_service_assetAdvanced";
    ...
    model_internal var _instance:_Super_Allinfo_service_assetAdvanced;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Allinfo_service_assetAdvancedEntityMetadata(value : _Super_Allinfo_service_assetAdvanced)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Allinfo_service_assetAdvanced");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Allinfo_service_assetAdvanced");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of Allinfo_service_assetAdvanced");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity Allinfo_service_assetAdvanced");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity Allinfo_service_assetAdvanced");
        }
