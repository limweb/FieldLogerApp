 ...
 * of this value object you may modify the generated sub-class of this class - CountSensor.as.
 */
...
[ExcludeClass]
public class _Super_CountSensor extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CountSensorEntityMetadata;
    ...
    private var _internal_countTool : int;
    ...
    public function _Super_CountSensor()
    {
        _model = new _CountSensorEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get countTool() : int
    {
        return _internal_countTool;
    }
    ...
    public function set countTool(value:int) : void
    {
        var oldValue:int = _internal_countTool;
        if (oldValue !== value)
        {
            _internal_countTool = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "countTool", oldValue, _internal_countTool));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CountSensorEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CountSensorEntityMetadata) : void
    {
        var oldValue : _CountSensorEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
