...
[ExcludeClass]
internal class _TreeToolSensorEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("tool_active", "tool_type", "toolNo", "children", "tool_name", "tool_sensor", "tool_note", "tool_5", "tool_4", "tool_3", "toolID", "tool_2", "tool_1");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("tool_active", "tool_type", "toolNo", "children", "tool_name", "tool_sensor", "tool_note", "tool_5", "tool_4", "tool_3", "toolID", "tool_2", "tool_1");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("tool_active", "tool_type", "toolNo", "children", "tool_name", "tool_sensor", "tool_note", "tool_5", "tool_4", "tool_3", "toolID", "tool_2", "tool_1");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("tool_active", "tool_type", "toolNo", "children", "tool_name", "tool_sensor", "tool_note", "tool_5", "tool_4", "tool_3", "toolID", "tool_2", "tool_1");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("tool_active", "tool_type", "toolNo", "children", "tool_name", "tool_sensor", "tool_note", "tool_5", "tool_4", "tool_3", "toolID", "tool_2", "tool_1");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array("children");
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "TreeToolSensor";
    ...
    model_internal var _instance:_Super_TreeToolSensor;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _TreeToolSensorEntityMetadata(value : _Super_TreeToolSensor)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity TreeToolSensor");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity TreeToolSensor");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of TreeToolSensor");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity TreeToolSensor");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity TreeToolSensor");
        }
