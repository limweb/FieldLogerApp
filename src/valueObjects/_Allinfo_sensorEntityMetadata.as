...
[ExcludeClass]
internal class _Allinfo_sensorEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("sensor_offset_b", "sensor_5", "sensor_note", "sensorNo", "sensor_gain_a", "sensor_name", "sensor_max", "sensorID", "sensor_type", "sensor_3", "sensor_4", "sensor_min", "sensor_1", "sensor_unit", "sensor_2", "toolID");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("sensor_offset_b", "sensor_5", "sensor_note", "sensorNo", "sensor_gain_a", "sensor_name", "sensor_max", "sensorID", "sensor_type", "sensor_3", "sensor_4", "sensor_min", "sensor_1", "sensor_unit", "sensor_2", "toolID");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("sensor_offset_b", "sensor_5", "sensor_note", "sensorNo", "sensor_gain_a", "sensor_name", "sensor_max", "sensorID", "sensor_type", "sensor_3", "sensor_4", "sensor_min", "sensor_1", "sensor_unit", "sensor_2", "toolID");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("sensor_offset_b", "sensor_5", "sensor_note", "sensorNo", "sensor_gain_a", "sensor_name", "sensor_max", "sensorID", "sensor_type", "sensor_3", "sensor_4", "sensor_min", "sensor_1", "sensor_unit", "sensor_2", "toolID");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("sensor_offset_b", "sensor_5", "sensor_note", "sensorNo", "sensor_gain_a", "sensor_name", "sensor_max", "sensorID", "sensor_type", "sensor_3", "sensor_4", "sensor_min", "sensor_1", "sensor_unit", "sensor_2", "toolID");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Allinfo_sensor";
    ...
    model_internal var _instance:_Super_Allinfo_sensor;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Allinfo_sensorEntityMetadata(value : _Super_Allinfo_sensor)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Allinfo_sensor");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Allinfo_sensor");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of Allinfo_sensor");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity Allinfo_sensor");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity Allinfo_sensor");
        }
