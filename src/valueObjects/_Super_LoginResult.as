...
public class _Super_LoginResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    private var _internal_returnValue : int;
    ...
    public function set returnValue(value:int) : void
    {
        var oldValue:int = _internal_returnValue;
        if (oldValue !== value)
        {
            _internal_returnValue = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "returnValue", oldValue, _internal_returnValue));
        }
    }
