...
[ExcludeClass]
internal class _Allreport_infoEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("report_startDate", "projectID", "report_locked", "report_personnel", "serviceID", "reportNo", "report_representative", "report_client", "report_endDate", "report_detail", "report_ref", "reportID");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("report_startDate", "projectID", "report_locked", "report_personnel", "serviceID", "reportNo", "report_representative", "report_client", "report_endDate", "report_detail", "report_ref", "reportID");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("report_startDate", "projectID", "report_locked", "report_personnel", "serviceID", "reportNo", "report_representative", "report_client", "report_endDate", "report_detail", "report_ref", "reportID");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("report_startDate", "projectID", "report_locked", "report_personnel", "serviceID", "reportNo", "report_representative", "report_client", "report_endDate", "report_detail", "report_ref", "reportID");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("report_startDate", "projectID", "report_locked", "report_personnel", "serviceID", "reportNo", "report_representative", "report_client", "report_endDate", "report_detail", "report_ref", "reportID");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Allreport_info";
    ...
    model_internal var _instance:_Super_Allreport_info;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Allreport_infoEntityMetadata(value : _Super_Allreport_info)
    {
        ...
        model_internal::propertyTypeMap["reportNo"] = "int";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Allreport_info");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Allreport_info");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of Allreport_info");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity Allreport_info");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity Allreport_info");
        }
