 ...
 * of this service wrapper you may modify the generated sub-class of this class - RealtimehidlsService.as.
 */
package services.realtimehidlsservice
{
...
[ExcludeClass]
internal class _Super_RealtimehidlsService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_RealtimehidlsService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "getAll");
         operation.resultType = valueObjects.Response;
        ...
        operation = new mx.rpc.remoting.Operation(null, "destroy");
         operation.resultType = valueObjects.Response;
        operations["destroy"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "searchs");
         operation.resultType = Object;
        operations["searchs"] = operation;
    ...
    {
        destination = "RealtimehidlsService";
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function insert(item:Object) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getbyid(id:Object) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function update(item:int) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function destroy(id:int) : mx.rpc.AsyncToken
    {
    ...
    /**
      * This method is a generated wrapper used to call the 'searchs' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function searchs() : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("searchs");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send() ;
        return _internal_token;
    }
