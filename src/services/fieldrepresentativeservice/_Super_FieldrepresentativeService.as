 ...
 * of this service wrapper you may modify the generated sub-class of this class - FieldrepresentativeService.as.
 */
package services.fieldrepresentativeservice
{
...
import valueObjects.Allrepresentative;

import mx.collections.ItemResponder;
import com.adobe.fiber.valueobjects.AvailablePropertyIterator;

[ExcludeClass]
internal class _Super_FieldrepresentativeService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_FieldrepresentativeService()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        valueObjects.Allrepresentative._initRemoteClassAlias();

        var operations:Object = new Object();
        var operation:mx.rpc.remoting.Operation;

        operation = new mx.rpc.remoting.Operation(null, "getAllField_representative");
         operation.resultElementType = valueObjects.Allrepresentative;
        ...
        operation = new mx.rpc.remoting.Operation(null, "getField_representativeByprojectID");
         operation.resultElementType = valueObjects.Allrepresentative;
        operations["getField_representativeByprojectID"] = operation;
        ...
        _serviceControl.source = "FieldrepresentativeService";
    ...
    {
        destination = "FieldrepresentativeService";
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function createField_representative(item:valueObjects.Allrepresentative) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function deleteField_representative(itemID:int) : mx.rpc.AsyncToken
    {
    ...
    /**
      * This method is a generated wrapper used to call the 'getField_representativeByprojectID' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getField_representativeByprojectID(projectID:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getField_representativeByprojectID");
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function updateField_representativeEditorColumn(item:valueObjects.Allrepresentative, Column:String) : mx.rpc.AsyncToken
    {
